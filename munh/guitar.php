    ...
    <tr>
      <td class="home">
        <ul>
          ...
          <li class="li"><a href="../munh/myacc1.php">My account</a></li>
          <li class="li"><a href="../saruul/login.php" onclick="return confirm('Are you sure you want to exit?');" >Logout</a></li>
        </ul>
      </td>
      <td>
        <button type="button" name="request" ><a href = "request.php"> Request</a></button>
